                ...
                <form action="" method="POST" enctype="multipart/form-data" class="row g-3">
                    <div class="col-md-6">
                        <div class="form-outline" data-mdb-input-init="">
                            ...
                            <label for="validationDefault01" class="form-label" style="margin-left: 0px;">Auction Name</label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-outline" data-mdb-input-init="">
                            ...
                            <label for="validationDefault02" class="form-label" style="margin-left: 0px;">Auction Event Description</label>
                            <div class="form-notch">
                                <div class="form-notch-leading" style="width: 9px;"></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-outline" data-mdb-input-init="">
                            <input type="datetime-local" class="form-control" name="startDate" min="<?php echo date('Y-m-d\TH:i'); ?>" required>
                            <label for="validationDefault05" class="form-label" style="margin-left: 0px;">Start Date and Time for Auction</label>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-outline" data-mdb-input-init="">
                            <input type="datetime-local" class="form-control" name="endDate" min="<?php echo date('Y-m-d\TH:i'); ?>" required>
                            <label for="validationDefault05" class="form-label" style="margin-left: 0px;">End Date and Time for Auction</label>
                        </div>
                    </div>
